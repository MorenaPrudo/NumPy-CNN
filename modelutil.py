...
class Model():
    def __init__(self,reg=0,learning_rate=1e-3, num_classes = 5,epochs=15,batch_size=150):
        self.epochs = epochs
    ...
    def train(self,X,y):
        for epoch in range(self.epochs):
            ...
            num_iter_per_epoch = num_of_training // batch_size if num_of_training % batch_size == 0 else num_of_training // batch_size + 1
    ...
    def train_pass(self,X,y):
        ...
        out, cache = layers.conv_forward(X, params['w2'], params['b2'], conv_param2)
        cache_array.append(cache)
        ...
        """
        conv pool norm relu conv pool norm relu flatten fc
